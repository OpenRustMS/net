// Taken form here https://github.com/OpenXbox/filetime_type-rs
// However due to trait restriction this has to be in this crate
...
impl FileTime {
    ...
    /// Construct new FileTime from raw i64 value
    pub const fn from_i64(filetime: i64) -> Self {
    ...
    /// Construct new FileTime from DateTime<Utc>
