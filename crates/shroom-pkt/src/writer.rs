...
use crate::{opcode::NetOpcode, Error, PacketResult, ShroomPacketData};
...
impl PacketWriter<BytesMut> {
    ...
    pub fn into_packet(self) -> ShroomPacketData {
        ShroomPacketData::from_writer(self)
    }
}
    ...
    T: BufMut,
{
    ...
    pub fn write_opcode(&mut self, op: impl NetOpcode) -> PacketResult<()> {
